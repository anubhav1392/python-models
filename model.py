...
scalar.fit(b_data.iloc[:,1:31])

########## Data Splitting#################
b_data_train,b_data_test=train_test_split(b_data,test_size=0.2,random_state=13)
x_train=b_data_train.iloc[:,1:31]
y_train=b_data_train['diagnosis']
x_test=b_data_test.iloc[:,1:31]
y_test=b_data_test['diagnosis']
